...
class PatientAddressModel {
  PatientAddressModel({required this.cep, required this.streetAddress, required this.state, required this.number, required this.addressComplement, required this.city, required this.district});
  ...
  PatientAddressModel copyWith({String? cep, String? streetAddress, String? state, String? number, String? addressComplement, String? city, String? district}) {
